...
class GiftMatchingNotebookGUI:
    def __init__(self):
        ...
        # File Upload Widgets
        self.children_upload = widgets.FileUpload(description="Upload Children File", accept=".csv")
        self.warehouse_upload = widgets.FileUpload(description="Upload Warehouse File", accept=".csv")
    ...
    def run_algorithm(self, b):
        ...
        self.app.children_file = self.save_file(self.children_upload)
        self.app.warehouse_file = self.save_file(self.warehouse_upload)
        ...
        if self.app.children_file and self.app.warehouse_file:
            ...
            with self.output_area:
                display(widgets.HTML("<p style='color:red;'>Error: Please upload both files!</p>"))

    def save_file(self, upload_widget):
        """Saves uploaded files and returns the file path."""
